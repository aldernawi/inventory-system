...
use Closure;
use Database\Factories\FlowerInvoiceFactory;
...
class FlowerInvoice extends Model
{
    /** @use HasFactory<FlowerInvoiceFactory> */
    use HasFactory;
    ...
    protected static function booted(): void
    {
        static::updating(function (self $invoice): void {
            ...
            throw new LogicException('Confirmed Flower invoices are immutable except through the cancellation service.');
        });

        static::deleting(function (self $invoice): void {
            if ($invoice->status !== InvoiceStatus::Draft) {
                throw new LogicException('Confirmed Flower invoices cannot be deleted.');
            }
        });
    }
    ...
    {
        return $this->hasMany(FlowerInvoiceItem::class, 'invoice_id');
    }
