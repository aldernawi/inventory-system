...
return new class extends Migration
{
    ...
    {
        Schema::create('flower_invoices', function (Blueprint $table): void {
            $table->id();
        ...
        if (DB::getDriverName() === 'mysql') {
            DB::statement('ALTER TABLE flower_invoices ADD CONSTRAINT flower_invoices_amounts_check CHECK (discount_amount <= subtotal_amount AND total_amount = subtotal_amount - discount_amount AND paid_amount <= total_amount AND remaining_amount = total_amount - paid_amount)');
        }
    }

    public function down(): void
    {
        Schema::dropIfExists('flower_invoices');
    }
};
