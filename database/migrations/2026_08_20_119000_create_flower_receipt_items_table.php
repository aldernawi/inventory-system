...
return new class extends Migration
{
    ...
    {
        Schema::create('flower_receipt_items', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('receipt_id')->constrained('flower_receipts')->restrictOnDelete();
